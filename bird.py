...
class Bird:
    ...
    def draw(self):
        ...
        if self.dir == 1:
            self.image.clip_draw(int(self.frame) * 150, 0, 150, 150, self.x, self.y,80,80)
        elif self.dir == -1:
            flip = 'h'
            self.image.clip_composite_draw(int(self.frame) * 150, 0, 150, 150, 0, flip, self.x, self.y,80,80)
